...
static struct layout_t
{
    ...
    {"GPIO1_C0", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  0}, {GPIO_SWPORT_DR_H,  0}, {GPIO_EXT_PORT,  0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C1", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  1}, {GPIO_SWPORT_DR_H,  1}, {GPIO_EXT_PORT,  1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C2", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H,  2}, {GPIO_SWPORT_DR_H,  2}, {GPIO_EXT_PORT,  2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C3", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H,  3}, {GPIO_SWPORT_DR_H,  3}, {GPIO_EXT_PORT,  3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C4", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H,  4}, {GPIO_SWPORT_DR_H,  4}, {GPIO_EXT_PORT,  4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C5", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H,  5}, {GPIO_SWPORT_DR_H,  5}, {GPIO_EXT_PORT,  5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C6", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H,  6}, {GPIO_SWPORT_DR_H,  6}, {GPIO_EXT_PORT,  6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_C7", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1C_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H,  7}, {GPIO_SWPORT_DR_H,  7}, {GPIO_EXT_PORT,  7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D0", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  8}, {GPIO_SWPORT_DR_H,  8}, {GPIO_EXT_PORT,  8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D1", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  9}, {GPIO_SWPORT_DR_H,  9}, {GPIO_EXT_PORT,  9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D2", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H, 10}, {GPIO_SWPORT_DR_H, 10}, {GPIO_EXT_PORT, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D3", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H, 11}, {GPIO_SWPORT_DR_H, 11}, {GPIO_EXT_PORT, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D4", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H, 12}, {GPIO_SWPORT_DR_H, 12}, {GPIO_EXT_PORT, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D5", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H, 13}, {GPIO_SWPORT_DR_H, 13}, {GPIO_EXT_PORT, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D6", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H, 14}, {GPIO_SWPORT_DR_H, 14}, {GPIO_EXT_PORT, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO1_D7", 1, 2, {CRU_GATE_CON16, 14}, {BUS_IOC_GPIO1D_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H, 15}, {GPIO_SWPORT_DR_H, 15}, {GPIO_EXT_PORT, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0}, 
    ...
    {"GPIO2_C0", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  0}, {GPIO_SWPORT_DR_H,  0}, {GPIO_EXT_PORT,  0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C1", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  1}, {GPIO_SWPORT_DR_H,  1}, {GPIO_EXT_PORT,  1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C2", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H,  2}, {GPIO_SWPORT_DR_H,  2}, {GPIO_EXT_PORT,  2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C3", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H,  3}, {GPIO_SWPORT_DR_H,  3}, {GPIO_EXT_PORT,  3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C4", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H,  4}, {GPIO_SWPORT_DR_H,  4}, {GPIO_EXT_PORT,  4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C5", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H,  5}, {GPIO_SWPORT_DR_H,  5}, {GPIO_EXT_PORT,  5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C6", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H,  6}, {GPIO_SWPORT_DR_H,  6}, {GPIO_EXT_PORT,  6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_C7", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2C_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H,  7}, {GPIO_SWPORT_DR_H,  7}, {GPIO_EXT_PORT,  7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D0", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  8}, {GPIO_SWPORT_DR_H,  8}, {GPIO_EXT_PORT,  8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D1", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  9}, {GPIO_SWPORT_DR_H,  9}, {GPIO_EXT_PORT,  9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D2", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H, 10}, {GPIO_SWPORT_DR_H, 10}, {GPIO_EXT_PORT, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D3", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H, 11}, {GPIO_SWPORT_DR_H, 11}, {GPIO_EXT_PORT, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D4", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H, 12}, {GPIO_SWPORT_DR_H, 12}, {GPIO_EXT_PORT, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D5", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H, 13}, {GPIO_SWPORT_DR_H, 13}, {GPIO_EXT_PORT, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D6", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H, 14}, {GPIO_SWPORT_DR_H, 14}, {GPIO_EXT_PORT, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO2_D7", 2, 2, {CRU_GATE_CON17, 0}, {BUS_IOC_GPIO2D_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H, 15}, {GPIO_SWPORT_DR_H, 15}, {GPIO_EXT_PORT, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    ...
    {"GPIO3_C0", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  0}, {GPIO_SWPORT_DR_H,  0}, {GPIO_EXT_PORT,  0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C1", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  1}, {GPIO_SWPORT_DR_H,  1}, {GPIO_EXT_PORT,  1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C2", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H,  2}, {GPIO_SWPORT_DR_H,  2}, {GPIO_EXT_PORT,  2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C3", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H,  3}, {GPIO_SWPORT_DR_H,  3}, {GPIO_EXT_PORT,  3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C4", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H,  4}, {GPIO_SWPORT_DR_H,  4}, {GPIO_EXT_PORT,  4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C5", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H,  5}, {GPIO_SWPORT_DR_H,  5}, {GPIO_EXT_PORT,  5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C6", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H,  6}, {GPIO_SWPORT_DR_H,  6}, {GPIO_EXT_PORT,  6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_C7", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3C_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H,  7}, {GPIO_SWPORT_DR_H,  7}, {GPIO_EXT_PORT,  7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D0", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  8}, {GPIO_SWPORT_DR_H,  8}, {GPIO_EXT_PORT,  8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D1", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  9}, {GPIO_SWPORT_DR_H,  9}, {GPIO_EXT_PORT,  9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D2", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H, 10}, {GPIO_SWPORT_DR_H, 10}, {GPIO_EXT_PORT, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D3", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H, 11}, {GPIO_SWPORT_DR_H, 11}, {GPIO_EXT_PORT, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D4", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H, 12}, {GPIO_SWPORT_DR_H, 12}, {GPIO_EXT_PORT, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D5", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIO3D_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H, 13}, {GPIO_SWPORT_DR_H, 13}, {GPIO_EXT_PORT, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D6", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIOXX_IOMUX_X,  8}, {GPIO_SWPORT_DDR_H, 14}, {GPIO_SWPORT_DR_H, 14}, {GPIO_EXT_PORT, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO3_D7", 3, 2, {CRU_GATE_CON17, 2}, {BUS_IOC_GPIOXX_IOMUX_X, 12}, {GPIO_SWPORT_DDR_H, 15}, {GPIO_SWPORT_DR_H, 15}, {GPIO_EXT_PORT, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},   
    ...
    {"GPIO4_C0", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  0}, {GPIO_SWPORT_DR_H,  0}, {GPIO_EXT_PORT,  0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C1", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  1}, {GPIO_SWPORT_DR_H,  1}, {GPIO_EXT_PORT,  1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C2", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H,  2}, {GPIO_SWPORT_DR_H,  2}, {GPIO_EXT_PORT,  2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C3", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H,  3}, {GPIO_SWPORT_DR_H,  3}, {GPIO_EXT_PORT,  3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C4", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H,  4}, {GPIO_SWPORT_DR_H,  4}, {GPIO_EXT_PORT,  4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C5", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H,  5}, {GPIO_SWPORT_DR_H,  5}, {GPIO_EXT_PORT,  5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C6", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_H,  8}, {GPIO_SWPORT_DDR_H,  6}, {GPIO_SWPORT_DR_H,  6}, {GPIO_EXT_PORT,  6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_C7", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4C_IOMUX_H, 12}, {GPIO_SWPORT_DDR_H,  7}, {GPIO_SWPORT_DR_H,  7}, {GPIO_EXT_PORT,  7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},    
    {"GPIO4_D0", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_L,  0}, {GPIO_SWPORT_DDR_H,  8}, {GPIO_SWPORT_DR_H,  8}, {GPIO_EXT_PORT,  8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D1", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_L,  4}, {GPIO_SWPORT_DDR_H,  9}, {GPIO_SWPORT_DR_H,  9}, {GPIO_EXT_PORT,  9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D2", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_L,  8}, {GPIO_SWPORT_DDR_H, 10}, {GPIO_SWPORT_DR_H, 10}, {GPIO_EXT_PORT, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D3", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_L, 12}, {GPIO_SWPORT_DDR_H, 11}, {GPIO_SWPORT_DR_H, 11}, {GPIO_EXT_PORT, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D4", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_H,  0}, {GPIO_SWPORT_DDR_H, 12}, {GPIO_SWPORT_DR_H, 12}, {GPIO_EXT_PORT, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D5", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIO4D_IOMUX_H,  4}, {GPIO_SWPORT_DDR_H, 13}, {GPIO_SWPORT_DR_H, 13}, {GPIO_EXT_PORT, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D6", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIOXX_IOMUX_X,  8}, {GPIO_SWPORT_DDR_H, 14}, {GPIO_SWPORT_DR_H, 14}, {GPIO_EXT_PORT, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
    {"GPIO4_D7", 4, 2, {CRU_GATE_CON17, 4}, {BUS_IOC_GPIOXX_IOMUX_X, 12}, {GPIO_SWPORT_DDR_H, 15}, {GPIO_SWPORT_DR_H, 15}, {GPIO_EXT_PORT, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
};
...
static int rk3588DigitalWrite(int i, enum digital_value_t value)
{
    ...
    printf("after  changing out_reg: %x\n",*out_reg);
    printf("\n");
